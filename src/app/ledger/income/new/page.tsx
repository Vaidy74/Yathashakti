...
import { BookOpen, ArrowUpRight, ChevronLeft, AlertCircle } from "lucide-react";
...
export default function AddIncomePage() {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      console.log("Submitting income transaction:", formData);
      ...
      setError("Failed to record income transaction. Please try again.");
    } finally {
      ...
      <div className="p-6">
        ...
        {showSuccess && (
          <div className="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded relative flex items-center">
            ...
            <span>Income transaction recorded successfully! Redirecting...</span>
          </div>
        )}
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">
              Record a new income transaction for your organization.
            </p>
          </div>
          <div className="px-4 py-5 sm:p-6">
            <TransactionForm type="income" onSubmit={handleSubmit} />
          </div>
        </div>
      </div>
    </DashboardLayout>
